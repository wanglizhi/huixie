	...
	<div class="container-fluid">
		...
		<div class="tabbable tabble-custom boxless">
			<ul class="nav nav-tabs">
				...
				<li>
					<a href="#user_cash" data-toggle="tab">返现记录</a>
				</li>
			</ul>
										...
										<div class="portlet sale-summary">
											...
											<ul class="unstyled">
												...
												<li>
													...
													<span class="sale-num" id="show_balance">$<?=$user['balance']?></span>
												</li>
											</ul>
										</div>
									</div>
															...
															<li class="control-group control-input">
																...
																<li class="control-group control-input">
																						...
																						<li class="control-group control-input">
																							...
																							<div class="controls" style="margin-left: 0px;">
																								<div class="input-prepend span6 m-wrap">
																									...
																									<span class="add-on" style="width: 20px !important;position: absolute;">$</span>
																									<input id="balance" name="balance" class="m-wrap span6" type="text" value="0" style="
																									width: 100%;
																									padding-left: 40px !important;
																									" onKeyUp="updateCash()"></div>
																								</li>
																							</ul>
																						</div>
																					</div>
																	...
																	<div class="tab-pane" id="user_trade">
																		<div class="portlet-body">
																			<?php
																			$data['tradeTable'] = $userTradeTable;
																			$data['page_info'] = $userTradeTable['page_info'];
																			$data['js_page_method'] = "change_user_trade_page";
																	...
																	<div class="tab-pane" id="user_cash">
																		<div class="portlet-body">
																			<?php
																			$data['cashTable'] = $userCashTable;
																			$data['page_info'] = $userCashTable['page_info'];
																			$data['js_page_method'] = "change_user_cash_page";
