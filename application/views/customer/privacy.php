<!-- BEGIN PAGE -->  
		<div class="page-content">
			...
			<p>百度非常重视用户信息的保护，在使用百度的所有产品和服务前，请您务必仔细阅读并透彻理解本声明。一旦您选择使用，即表示您认可并接受本条款现有内容及其可能随时更新的内容。</p>
			  <h3>一、信息收集</h3>
			  <p>1. 您向百度提供的信息。为了向您提供更好的用户服务,百度会在您自愿选择服务或提供信息的情况下系统自动存储注册信息。请您在注册时及时、详尽及准确的提供个人资料，并不断更新注册资料。所有原始键入的资料将引用为注册资料。如果因注册信息不真实而引起的问题，由您自行承担相应的后果。请您不要将您的帐号、密码转让或出借予他人使用。如您发现您的帐号遭他人非法使用，应立即通知百度。互联网上不排除因黑客行为或用户的保管疏忽导致帐号、密码遭他人非法使用，此类情况与百度无关。</p>
			  <h3>二、因您使用产品或服务获取的信息</h3>
			  <p>1. 日志信息。当您使用百度服务时，服务器会自动记录一些信息，例如您对我们服务的使用情况、IP地址、所访问服务的URL、浏览器的类型和使用的语言以及访问日期和时间等。例如：
...
5. 以上数据信息都采用匿名的方式。同时，我们也会对信息采取加密处理，保证信息的安全性。</p>
<h3>三、信息使用</h3>
<p>1. 通过使用收集的信息，百度会得以向您提供个性化的服务，例如向您展现相关程度更高的搜索结果或者推广信息结果。上述信息还可以帮助百度改进百度的产品或服务，并用于开发新的产品或服务。
...
<h3>四、信息安全</h3>
<p>1. 百度非常重视信息安全，百度成立了专责团队，研发和应用多种安全技术和程序等，通过这些严格措施努力保护您的信息不被未经授权的访问、使用或泄漏。

2. 请您使用passport.baidu.com的密保工具服务进一步保障您的信息安全。</p>
			  <p><a class="btn green btn-lg" role="button" href="<?php echo site_url("customer/order/addOrderPage");?>">返回下单</a></p>
			</div>
